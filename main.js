...
Developer : @fahrizyteamznx`;
    ...
    bot.telegram.getMe().then((getme) => {
        console.table({
            ...
            "Author": "https://t.me/fahrizyteamznx"
        })
    })
...
console.log(chalk.blue.bold(`Nomer yang Terkoneksi ${XeonBotInc.user.id.split(":")[0]}`));
            XeonBotInc.sendMessage("6285820360355@s.whatsapp.net", { text: `🦄 Telegram bot connected!!` });
            resolve(XeonBotInc);
        }
    });
